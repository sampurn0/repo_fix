<html>
    ...
    <body>
		...
		?>
				...
				<table style="width: 100%; font-size: 10px; display: none" class="fifth">
					<tr>
				...
				<table style="width: 100%; font-size: 10px" class="fifth">
					...
					<tr>
						...
						<td class="nobordertop noborderbottom" align="center">
							<img style="padding-top: 2px; padding-left: 2px" src="<?=realpath(__DIR__ . '/../../../../upload/qrcode_karyawan')?>/<?=$id_karyawan_1?>.png" width="62" height="62"></img>
						</td>
						<td class="nobordertop noborderbottom" align="center">
							<img style="padding-top: 2px; padding-left: 2px; visibility: <?=($custodian_2=="" ? "hidden" : "visible")?>" src="<?=realpath(__DIR__ . '/../../../../upload/qrcode_karyawan')?>/<?=$id_karyawan_2?>.png" width="62" height="62"></img>
						</td>
					...
					<tr>
						<td style="width: 16.6%" class="nobordertop noborderright" align="center">DUTY CPC</td>
						<td style="width: 16.6%" class="nobordertop noborderright noborderleft" align="center"><u><?=$nama_custody_1?></u><br>CUSTODY</td>
						<td style="width: 16.6%" class="nobordertop noborderright" align="center"><u><?=($nama_custody_2=="" ? "-none-" : $nama_custody_2)?></u><br>CUSTODY</td>
