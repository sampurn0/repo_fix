			...
			<section class="grid_14">
			    <div class="widget_wrap tabby">
			        <div class="widget_top">
						...
						<img style="float: left; margin: 10px 3px 0px 8px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/dash.png" width="20" height="20">
			            <h6 style="margin: 0px 0px 0px -10px;">Main Dashboard & Summary Information</h6>
			            <div id="widget_tab">
			                <ul>
			                    <li><a href="#tab1" class="active_tab"><img style="float: left; margin: 10px 3px 0px -10px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/dash.png" width="20" height="20">Monitoring Statistics</a></li>
			                ...
			                <div class="stat_block black_rev">
			                    <div class="grid_6">
			                        <div class="widget_wrap">
			                            <div class="widget_top">
			                                <img style="float: left; margin: 10px 3px 0px 5px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/status.png" width="20" height="20">
			                                <h6 style="margin: 0px 0px 0px -10px;">Daily Monitoring (ATM, CDM, CRM)</h6>
			                            </div>
			                    ...
			                    <div class="grid_6">
			                        <div class="widget_wrap">
			                            <div class="widget_top">
			                                <img style="float: left; margin: 10px 3px 0px 5px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/status.png" width="20" height="20">
			                                <h6 style="margin: 0px 0px 0px -10px;">Daily Monitoring (CIT)</h6>
			                            </div>
			                    ...
			                    <div class="grid_6">
			                        <div class="widget_wrap">
			                            <div class="widget_top">
			                                <img style="float: left; margin: 10px 3px 0px 5px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/status.png" width="20" height="20">
			                                <h6 style="margin: 0px 0px 0px -10px;">Job Runsheets</h6>
			                            </div>
			                    ...
			                    <div class="grid_6">
			                        <div class="widget_wrap">
			                            <div class="widget_top">
			                                <img style="float: left; margin: 10px 3px 0px 5px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/status.png" width="20" height="20">
			                                <h6 style="margin: 0px 0px 0px -10px;">Trouble Tickets</h6>
			                            </div>
			            ...
			            <div id="tab2">
			                <div class="stat_block black_rev">
			                    ...
			                    <section class="grid_12">
			                        <div class="widget_wrap">
			                            <div class="widget_top">
			                                <img style="float: left; margin: 10px 3px 0px 5px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/Pie-Chart.png" width="20" height="20">
			                                <h6 style="margin: 0px 0px 0px -10px;">Recent Runsheets</h6>
			                            </div>
			                            <div class="widget_content">
			            ...
			            <div id="tab3">
			                <div class="stat_block black_rev">
			                    <section class="grid_12">
			                        <div class="widget_wrap">
			                            <div class="widget_top">
			                                <img style="float: left; margin: 10px 3px 0px 5px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/document-bookmark.png" width="20" height="20">
			                                <h6 style="margin: 0px 0px 0px -10px;">STATUS TROUBLE TICKETS</h6>
			                            </div>
			                            <div class="widget_content">
			                                <table class="display data_tbl">
			                                    <thead>
			            ...
			            <div id="tab4">
			                <div class="stat_block black_rev">
			                    <div class="grid_12">
			                        <div class="widget_wrap">
			                            <div class="widget_top">
			                                <img style="float: left; margin: 10px 3px 0px 5px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/loc.png" width="20" height="20">
			                                <h6 style="margin: 0px 0px 0px -10px;">Maps Global Tracking</h6>
			                            </div>
			                ...
			                <div class="stat_block black_rev">
			                    <div class="grid_12">
			                        <div class="widget_wrap">
			                            <div class="widget_top">
			                                <img style="float: left; margin: 10px 3px 0px 5px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/loc.png" width="20" height="20">
			                                <h6 style="margin: 0px 0px 0px -10px;">Maps CIT & CR</h6>
			                            </div>
			                ...
			                <div class="stat_block black_rev">
			                    <div class="grid_12">
			                        <div class="widget_wrap">
			                            <div class="widget_top">
			                                <img style="float: left; margin: 10px 3px 0px 5px;" src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/loc.png" width="20" height="20">
			                                <h6 style="margin: 0px 0px 0px -10px;">Maps FLM & SLM</h6>
			                            </div>
